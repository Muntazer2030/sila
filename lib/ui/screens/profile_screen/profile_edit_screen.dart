...
class _ProfileEditScreenState extends State<ProfileEditScreen> {
  ...
  void _updateSubCategories() {
    ...
    if (subCategories.isNotEmpty &&
        !subCategories.contains(formData.subCategory)) {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              isEditMode ? 'تم تحديث البيانات بنجاح!' : 'تمت الإضافة بنجاح!',
            ),
          ),
        );
                          ...
                          child: Row(
                            children: [
                                  ...
                                  children: [
                                    Text(
                                      isEditMode
                                          ...
                                          : "إضافة سجل جديد (${formData.mainCategory})",
                              ...
                              ElevatedButton.icon(
                                ...
                                label: Text(
                                  isEditMode ? "حفظ التعديلات" : "حفظ وإضافة",
          ...
          Row(
            children: [
              ...
              Expanded(
                child: _buildTextField(
                  "Snapchat",
                  formData.snapchatUrl,
                  (val) => formData.snapchatUrl = val,
                ),
              ),
            ],
          ),
    ...
    return _buildCardWrapper(
      ...
      child: Row(
        children: [
          ...
          const SizedBox(width: 15),
          Expanded(
            child: _buildDropdown("العمر", formData.ageGroup, [
              "18-24",
              "25-39",
              "40-55",
              "55+",
      ...
      child: Column(
        children: [
          Row(
            children: [
              Expanded(
                child: _buildDropdown("نوع العلاقة", formData.status, [
                  "شراكة",
                  "تعاون",
                  "دعم إعلامي",
                  "حضور فعاليات",
              ...
              Expanded(
                child: _buildTextField(
                  "عدد مرات التعاون",
                  formData.cooperationCount,
                  (val) => formData.cooperationCount = val,
                ),
              ),
            ],
          ),
          _buildRatingField(
            "تقييم العلاقة (من 1 إلى 5)",
            formData.rating,
          ...
          InkWell(
            ...
            child: Container(
              ...
              child: Row(
                ...
                children: [
                  Text(
                    currentValue.isEmpty ? "اختر الوقت..." : currentValue,
                    style: TextStyle(
                      fontSize: 13,
